...
int main() {
  ...
  do {
    ...
    switch (tolower(choice)) {
      case '1': processLoadCourses(school); break; // DONE
      case '2': processLoadStudents(school); break; // DONE
      ...
      case '6': school.listCourses(); break; // DONE
      case '7': school.listStudents(); break; // DONE
